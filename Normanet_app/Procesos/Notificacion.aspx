<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="Notificacion.aspx.vb" Inherits="Normanet_app.Notificacion" %>
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <telerik:RadToolBar ID="btnCuentas" Runat="server" Height="32" Width="100%" SkinID="SkinManager" OnClientButtonClicking="clientButtonClicking">  
            <Items>
                ...
                <telerik:RadToolBarButton Enabled="true" Value="6" ImageUrl="../Imagenes/Botoneras/notificacion.png" Text="Enviar" ToolTip="Enviar"/>
        ...
        <div>
            <table style="width: 100%; height:100px;" class="SinBorde">
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel1" Text="Título de Notificación" runat="server"></telerik:RadLabel>
                    </th>
                    <th>
                        <telerik:RadLabel ID="RadLabel2" Text="No. Sesión" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../Imagenes/Botoneras/mundo.png" />
                    </td>
                    <td>
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../Imagenes/Botoneras/copy.png" />
                    </td>
                    <td></td>
                  </tr>
                  <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="../Imagenes/Botoneras/paste.png" />
                    </td>
                    <td></td>
                  </tr>
                  <tr>
                    <td colspan="5">
                        <telerik:RadLabel ID="RadLabel3" Text="Contenido" runat="server"></telerik:RadLabel>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="5">
                        <textarea id="TextArea1" style="width: 510px; height: 346px;" cols="20" rows="2"></textarea>
                    </td>
                  </tr>
                </table>
        </div>
