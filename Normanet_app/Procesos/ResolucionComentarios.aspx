<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="ResolucionComentarios.aspx.vb" Inherits="Normanet_app.ResolucionComentarios" %>
          ...
          <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" ID="RadPageView2">
                <table>
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel13" Text="Fecha de Publicación a periodo de Comentario Público:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
                    ...
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel15" Text="Fecha Límite a Análisis Comentarios:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
                    ...
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel16" Text="Título:" runat="server"></telerik:RadLabel>
                        </th>
                         <td style="Width:350px; height:60px">
                             <textarea id="TextArea6" style="width:100%; height:100%" cols="20" rows="2"></textarea>
                         </td>
                    </tr>
                </table>
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageView3">
                        <table>
                            <tr>
                               <th>
                                   <telerik:RadLabel ID="RadLabel7" Text="No. Comentarios Editoriales:" runat="server"></telerik:RadLabel>
                               </th>
                                <td>
                                    <telerik:RadNumericTextBox ID="RadNumericTextBox1" runat="server"></telerik:RadNumericTextBox>
                                </td>
                                <th>
                                   <telerik:RadLabel ID="RadLabel17" Text="No. Comentarios Técnico:" runat="server"></telerik:RadLabel>
                               </th>
                                <td>
                            ...
                            <tr>
                               <th>
                                   <telerik:RadLabel ID="RadLabel18" Text="Adjuntar Matriz de Comentarios:" runat="server"></telerik:RadLabel>
                            ...
                            <tr>
                               <th>
                                    <telerik:RadLabel ID="RadLabel19" Text="Resolución:" runat="server"></telerik:RadLabel>
                            ...
                            <tr>
                                <th>
                                    <telerik:RadLabel ID="RadLabel20" Text="Fecha:" runat="server"></telerik:RadLabel>
                                </th>
                                 <th>
                                      <telerik:RadLabel ID="RadLabel21" Text="Adjuntar Matriz Resolución de Comentarios:" runat="server"></telerik:RadLabel>
                                 </th>
                            </tr>
                            <tr>
                                <td>
