<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="Noticias.aspx.vb" Inherits="Normanet_app.Noticias" %>
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <div>
            <table style="width: 100%; height:100px;" class="SinBorde">
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel1" Text="Id Noticia:" runat="server"></telerik:RadLabel>
                </th>
                <td>
              ...
              <tr>
               <th>
                    <telerik:RadLabel ID="RadLabel2"  Text="Fecha:" runat="server"></telerik:RadLabel>
                </th>
                <td>
              ...
              <tr>
               <th>
                    <telerik:RadLabel ID="RadLabel3"  Text="Título:" runat="server"></telerik:RadLabel>
                </th>
                <td>
                    <telerik:RadTextBox ID="RadTextBox1" Width="500px" runat="server"></telerik:RadTextBox>
                </td>
              </tr>
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel4"  Text="Fuente:" runat="server"></telerik:RadLabel>
                </th>
                <td>
                    <telerik:RadTextBox ID="RadTextBox2" Width="500px" runat="server"></telerik:RadTextBox>
                </td>
              </tr>
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel5"  Text="Noticia:" runat="server"></telerik:RadLabel>
                </th>
                <td>
                    <telerik:RadTextBox ID="RadTextBox3" Width="500px" runat="server"></telerik:RadTextBox>
                </td>
              </tr>
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel6" Text="Categoría:" runat="server"></telerik:RadLabel>
                </th>
                <td>
              ...
              <tr>
                ...
                <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel8" Text="Activo:" runat="server"></telerik:RadLabel>
                </th>
                <td>
