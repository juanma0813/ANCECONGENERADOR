<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="CerrarSesionesRealizadas.aspx.vb" Inherits="Normanet_app.CerrarSesionesRealizadas" %>
            ...
            <table style="width: 100%; height:100px;" class="SinBorde">
                <tr>
                    <td colspan="2" style="text-align:center">
                        <telerik:RadLabel ID="RadLabel18" Text="Sesiones:" runat="server"></telerik:RadLabel>
