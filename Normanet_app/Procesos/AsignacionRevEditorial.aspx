<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="AsignacionRevEditorial.aspx.vb" Inherits="Normanet_app.AsignacionRevEditorial" %>
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <telerik:RadToolBar ID="btnCuentas" Runat="server" Height="32" Width="100%" SkinID="SkinManager" OnClientButtonClicking="clientButtonClicking">  
            <Items>
                ...
                <telerik:RadToolBarButton Enabled="true" Value="3" ImageUrl="../Imagenes/Botoneras/asignar.png" Text="Asignar" ToolTip="Asignar"/>
        ...
        <div>
            <table style="width: 100%; height:100px;" class="SinBorde">
              <tr>
                <td rowspan="6" style="width: 40%; height:200px">
                ...
                <th>
                    <telerik:RadLabel ID="RadLabel9" Text="Fecha de Entrega al Revisor:" runat="server"></telerik:RadLabel>
                </th>
                <td>
              ...
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel10" Text="Responsable Revisión:" runat="server"></telerik:RadLabel>
                </th>
                <td colspan="2">
                ...
                <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel11" Text="Número de Páginas:" runat="server"></telerik:RadLabel>
                </th>
                <td>
                ...
                <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel12" Text="Fecha Compromiso de Respuesta del Revisor:" runat="server"></telerik:RadLabel>
                </th>
                <td>
                ...
                <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel13" Text="Archivo:" runat="server"></telerik:RadLabel>
                </th>
                <td colspan="2">
