<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="pnn.aspx.vb" Inherits="Normanet_app.pnn" %>
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <div>
            <table style="width: 100%; height:100px;" class="SinBorde">
                  ...
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel3" Text="Tipo:" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                        <asp:RadioButton ID="RadioButton1" Text="Programa" runat="server" />
                        <br />
                        <asp:RadioButton ID="RadioButton2" Text="Suplemento" runat="server" />
                    </td>
                  </tr>
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel4" Text="Fecha Inicial:" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                  ...
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel5" Text="Fecha Final:" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                  ...
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel6" Text="Fecha de envio a CNN:" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                  ...
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel7" Text="Fecha de Publicación en DOF:" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                  ...
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel8" Text="Fecha de Primera Publicación:" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
