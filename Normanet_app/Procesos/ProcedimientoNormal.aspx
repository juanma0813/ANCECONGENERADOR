<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="ProcedimientoNormal.aspx.vb" Inherits="Normanet_app.ProcedimientoNormal" %>
          ...
          <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" ID="RadPageView2">
                <table>
                    ...
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel15" Text="Fecha de Publicación a periodo de Comentario Público:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
                    ...
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel16" Text="Fecha Límite para Comentarios:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
