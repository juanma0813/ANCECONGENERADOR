<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="ProcedimientoAlternativo.aspx.vb" Inherits="Normanet_app.ProcedimientoAlternativo" %>
        ...
        <div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <Tabs>
                        <telerik:RadTab Text="Datos Personales/Comentarios" Width="200px" Font-Size="12px" Height="10px" ></telerik:RadTab>
                        <telerik:RadTab Text="Proc. Alternativo" Width="150px" Font-Size="12px" Height="10px"></telerik:RadTab>
                        <telerik:RadTab Text="Matriz de Comentarios" Font-Size="12px" Width="200px" Height="10px" ></telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
          <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage">
                 <telerik:RadPageView runat="server" ID="RadPageView1">
                     <table style="width: 100%; height:100px;" class="SinBorde">
                          ...
                          <tr>
                            <td></td>
                            <td colspan="2">
                                <telerik:RadLabel ID="RadLabel7" Text="Tipo de Captura:" runat="server"></telerik:RadLabel><br />
                                <asp:RadioButton ID="RadioButton1" Text="Manual" runat="server" /><asp:RadioButton ID="RadioButton2" Text="Directorio" runat="server" />
                            </td>
                          </tr>
                          <tr>
                            <th>
            ...
            <telerik:RadPageView runat="server" ID="RadPageView2">
                <table>
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel13" Text="PNN:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
                    ...
                    <tr>
                        <th>
                             <telerik:RadLabel ID="RadLabel14" Text="Clasificación:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
                    ...
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel15" Text="Fecha de Inicio de Comentarios:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
                    ...
                    <tr>
                        <th>
                            <telerik:RadLabel ID="RadLabel16" Text="Fecha Fin de Comentarios:" runat="server"></telerik:RadLabel>
                        </th>
                         <td>
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageView3">
                        <table>
                            <tr>
                                <th>
                                    <telerik:RadLabel ID="RadLabel17" Text="No. Comentarios Editoriales:" runat="server"></telerik:RadLabel>
                                </th>
                                <td>
                                    <telerik:RadNumericTextBox ID="RadNumericTextBox1" runat="server"></telerik:RadNumericTextBox>
                                </td>
                                 <th>
                                    <telerik:RadLabel ID="RadLabel18" Text="No. Comentarios Técnicos:" runat="server"></telerik:RadLabel>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <telerik:RadLabel ID="RadLabel19" Text="Adjuntar Matriz de Comentarios:" runat="server"></telerik:RadLabel>
                                </th>
                                <td colspan="3">
