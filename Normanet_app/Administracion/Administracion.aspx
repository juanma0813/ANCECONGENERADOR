<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="Administracion.aspx.vb" Inherits="Normanet_app.Administracion" %>
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <div>
            <table style="width: 100%; " class="SinBorde">
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel1" Text="Grupos:" runat="server"></telerik:RadLabel>
                </th>
                <td colspan="2">
                ...
                <tr>
                    <td colspan="3">
                        <table style="width: 100%; " class="SinBorde">
                                         <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel2" Text="Menús Inactivos" runat="server"></telerik:RadLabel>
                </th>
                <td></td>
                <th>
                    <telerik:RadLabel ID="RadLabel3" Text="Menús Activos" runat="server"></telerik:RadLabel>
                </th>
              </tr>
              <tr>
                <td>
                    <telerik:RadGrid ID="RadGrid2" BackColor="Gray" Width="100%" Height="125px" runat="server"></telerik:RadGrid>
                </td>
                <td style="width:50px">
                    <table>
                        <tr>
                ...
                <td>
                    <telerik:RadGrid ID="RadGrid1" BackColor="Gray" Width="100%" Height="125px" runat="server"></telerik:RadGrid>
                </td>
              </tr>
                        </table>
                    </td>
