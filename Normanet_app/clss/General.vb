...
Module General
    ...
    Public Sub MsgJquery(obj As Object, Mensaje As String, Titulo As String)
        ...
        ScriptManager.RegisterClientScriptBlock(obj, obj.GetType, Guid.NewGuid.ToString,
"$('<div><br /><div style=""text-align:center;"">" & Mensaje & "</div></div>').dialog({title:'" 
& Titulo & "',zIndex:'4001',autoOpen:true,modal:true,buttons: {'Aceptar': function() {$( this ).dialog('close'); LimpiarFormulario()}}});", True)
    End Sub
