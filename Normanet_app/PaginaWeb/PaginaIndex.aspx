<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="PaginaIndex.aspx.vb" Inherits="Normanet_app.PaginaIndex" %>
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <div>
            <table style="width: 100%; height:100px;" class="SinBorde">
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel1" Text="Grupo:" runat="server"></telerik:RadLabel>
                </th>
                <td colspan="2">
              ...
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel2" Text="Nombre Liga:" runat="server"></telerik:RadLabel>
                </th>
                <td colspan="4">
              ...
              <tr>
                <th>
                    <telerik:RadLabel ID="RadLabel3" Text="Texto:" runat="server"></telerik:RadLabel>
                </th>
                <td colspan="4">
