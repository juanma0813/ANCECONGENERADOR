...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <br />
        <div>
                    <telerik:RadTabStrip RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" Skin="Vista">
            <Tabs>
                <telerik:RadTab Text="Directorio"  Font-Size="10px" Width="100px" Height="15px"></telerik:RadTab>
                <telerik:RadTab Text="Registros Directorio, Proximos y Vencidos" Width="300px"  Font-Size="10px" Height="15px"></telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage">
            ...
            <telerik:RadPageView runat="server" ID="RadPageView2">
                <table style="width: 100%; height:100px;" class="SinBorde">
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel8" Text="Por Comité" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                        <telerik:RadCheckBox ID="RadCheckBox1" runat="server" Text=""></telerik:RadCheckBox>
                    </td>
                    <th>
                        <telerik:RadLabel ID="RadLabel9" Text="Comité:" runat="server"></telerik:RadLabel>   
                    </th>
                    <td>
                  ...
                  <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel10" Text="Próximos y Vencidos" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                    ...
                    <tr>
                    <th>
                        <telerik:RadLabel ID="RadLabel11" Text="Nombramiento" runat="server"></telerik:RadLabel>
                    </th>
                    <td>
                  ...
                  <tr>
                    ...
                    <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed">
                        <ColumnGroups>
                            ...
                            <!----------------------------------B O T O N E R A--------------------------------------------->
                    <telerik:RadToolBar ID="RadToolBar1" Runat="server" Height="35" Width="100%" SkinID="SkinManager" OnClientButtonClicking="clientButtonClicking">  
                        <Items>
