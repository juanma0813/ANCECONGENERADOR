<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="PropiedadesTemas.aspx.vb" Inherits="Normanet_app.PropiedadesTemas" %>
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <telerik:RadToolBar ID="btnCuentas" Runat="server" Height="32" Width="100%" SkinID="SkinManager" OnClientButtonClicking="clientButtonClicking">  
            <Items>
                ...
                <telerik:RadToolBarButton Enabled="true" Value="6" ImageUrl="../Imagenes/Botoneras/inhabilitar.png" Text="Inhactivar" ToolTip="Inactivar"/>
        ...
        <div>
            <table style="width: 100%;" class="SinBorde">
                    <tr>
                        <th style="width:30%">
                            <telerik:RadLabel ID="RadLabel7" Text="Formulario:" runat="server"></telerik:RadLabel>
                        </th>
                        <td style="width:60%">
                            <asp:DropDownList ID="DropDownList1" Width="450px" runat="server"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <th style="width:30%">
                            <telerik:RadLabel ID="RadLabel8" Text="Tipo de campo:" runat="server"></telerik:RadLabel>
                        </th>
                        <td style="width:60%">
                            
                           <asp:DropDownList ID="DropDownList2" Width="450px" runat="server"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <th style="width:30%">
                            <telerik:RadLabel ID="RadLabel1" Text="Descripción:" runat="server"></telerik:RadLabel>
                        </th>
                        <td style="width:60%">
                            
                           <telerik:RadTextBox Width="450px" runat="server" ></telerik:RadTextBox>
                        </td>
                    </tr>
