<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mpFormularios.Master" CodeBehind="Etapa.aspx.vb" Inherits="Normanet_app.Etapa" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphAreaTrabajo" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rapContenedor" runat="server" Width="100%" LoadingPanelID="ralLoad">
        ...
        <div>
            <table style="width: 100%;" class="SinBorde">
                    <tr>
                        <th style="width:30%">
                            <telerik:RadLabel ID="RadLabel7" Text="Etapa:" runat="server"></telerik:RadLabel>
                        </th>
                        <td style="width:60%">
                    ...
                    <tr>
                        <th style="width:30%">
                            <telerik:RadLabel ID="RadLabel8" Text="Ponderación avance:" runat="server"></telerik:RadLabel>
                        </th>
                        <td style="width:60%">
